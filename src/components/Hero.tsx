...
const Hero: React.FC = () => {
  return (
    <>
      <Nav />
      <section
        className="relative h-screen bg-cover bg-center pt-20"  // pt-20 adds padding to avoid overlap with fixed nav
        style={{ backgroundImage: `url('/hero.jpg')` }}
      >
        <div className="absolute inset-0 bg-black opacity-25"></div>
        <div className="relative z-10 flex flex-col justify-center items-center h-full">
          <div className="bg-white bg-opacity-90 p-10 rounded-xl text-center max-w-lg">
            <h1 className="text-3xl font-bold mb-6">Discover Workspace Where You & Your Team Can Work & Be Productive</h1>
            <div className="flex items-center bg-white border border-gray-300 rounded-full mb-6">
              <div className="flex items-center pl-4">
                ...
                <select className="bg-transparent focus:outline-none text-lg p-4 ">
            ...
            <button className="bg-purple-600 text-white text-lg font-semibold py-3 px-8 rounded-full hover:bg-purple-950">
              Get Started
            </button>
          </div>
