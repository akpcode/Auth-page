...
const App: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!newErrors.email && !newErrors.password) {
      ...
      // Navigate to the Hero page after successful login
      navigate('/Hero');
    }
        ...
        <div className="max-w-4xl w-full mx-auto bg-gray-800 rounded-lg shadow-md overflow-hidden flex">
          <div className="hidden md:block w-1/2 bg-gradient-to-br from-purple-700 to-black p-10">
            <div className="flex flex-col justify-center h-full text-center">
              ...
              <p className="text-gray-300 mb-6">
                Complete these easy steps to start enjoying our services.
              </p>
              <ol className="text-left text-white">
                <li className="mb-2 flex items-center">
                  <span className="mr-2 w-6 h-6 rounded-full bg-white text-black flex items-center justify-center">
                    1
                  </span>
                  Sign up your account
                </li>
                <li className="mb-2 flex items-center">
                  <span className="mr-2 w-6 h-6 rounded-full bg-gray-700 text-white flex items-center justify-center">
                    2
                  </span>
                  Find your preferred workspace
                </li>
                <li className="mb-2 flex items-center">
                  <span className="mr-2 w-6 h-6 rounded-full bg-gray-700 text-white flex items-center justify-center">
                    3
          ...
          <div className="w-full md:w-1/2 p-10 bg-gray-100">
            <form onSubmit={handleSubmit} className="w-full">
              ...
              <div className="my-4">
                <div
                  className={`flex items-center gap-5 p-4 rounded transition-all ${
                    errors.email ? 'border border-red-500' : 'bg-gray-200'
                  }`}
                >
              ...
              <div className="my-4">
                <div
                  className={`flex items-center gap-5 p-4 rounded transition-all ${
                    errors.password ? 'border border-red-500' : 'bg-gray-200'
                  }`}
                >
              ...
              <button
                type="submit"
                className="w-full bg-purple-900 text-white py-2 rounded hover:bg-purple-950"
                disabled={loading}
              >
            ...
            <div className="mt-4 flex justify-center">
              <Link
                to="/Register"
                className="w-full bg-gray-100 text-gray-700 py-2 rounded border border-purple-600 text-center hover:bg-gray-200"
              >
                Create new account
              </Link>
            </div>
